...
/*   Updated: 2020/12/16 14:22:46 by hbaudet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	deque<string> JOHN;
	deque<string> BOB(5, "Hello");
	cout << "BOB(5, 8) : ";
	print(BOB);
	deque<string> MIKE(BOB);
	...
	print(insert_in_me);
	deque<string>::const_iterator const_it(insert_in_me.begin());
...
//	*const_it = 89; // Does not compile because it's a const_iterator
	...
	deque<string> real;
	real.assign(5, "foo");
	for (deque<string>::iterator it = real.begin(); it != real.end(); it++)
		cout << *it << " ";
	cout << '\n';
