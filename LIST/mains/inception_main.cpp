...
/*   Updated: 2021/01/18 16:04:25 by hbaudet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	list<list<int> >::const_iterator const_it(insert_in_me.begin());
	...
	//INSERT
	cout << "\nINSERT\n";
	list<list<int> >	std_insert_in_me;
	for (int i = 0; i < 15; i++)
		std_insert_in_me.push_back(test);
	print(insert_in_me);

	list<list<int> >::iterator	std_tmp;
