...
/*   Updated: 2021/01/18 16:04:22 by hbaudet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	list<int>::const_iterator const_it(insert_in_me.begin());
...
//	*const_it = 89; // Does not compile because it's a const_iterator
	...
	//INSERT
	cout << "\nINSERT\n";
	list<int>	std_insert_in_me;
	for (int i = 0; i < 15; i++)
		std_insert_in_me.push_back(i);
	print(insert_in_me);

	list<int>::iterator	std_tmp;
